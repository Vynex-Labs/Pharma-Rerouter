...
| P10 | Testing | P9 | **COMPLETE** (APR-P10-001) | QA Engineer | Master Orchestrator |
...
| P13 | Independent Audit | P10, P11, P12 | **NOT STARTED** (unblocked — next) | Independent Auditor | (findings not alterable by Orchestrator) |
...
**Critical path (P0–P12 done):** P13 → P14 → P15 → P16 → P17 → P18 → P19 → P20 → P21.
